...
export default function Home() {
  return (
    <main className="min-h-screen relative flex items-center justify-center p-4 bg-[#F5F1EE]">
      ...
      <div className="absolute left-0 top-[62%] -translate-y-1/2 -translate-x-1/3 pointer-events-none hidden lg:flex items-center justify-center">
        <Image
      ...
      <div className="absolute right-0 top-[62%] -translate-y-1/2 pointer-events-none hidden lg:flex items-center justify-center">
        <Image
